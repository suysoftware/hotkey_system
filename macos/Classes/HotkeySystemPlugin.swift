...
public class HotkeySystemPlugin: NSObject, FlutterPlugin {
    var channel: FlutterMethodChannel!
    
    var hotKeyDict: Dictionary<String, HotKey> = [:]
    
    public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "hotkey_system", binaryMessenger: registrar.messenger)
        let instance = HotkeySystemPlugin()
