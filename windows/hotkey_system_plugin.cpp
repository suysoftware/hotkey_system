...
class HotkeySystemPlugin : public flutter::Plugin {
 public:
...
void HotkeySystemPlugin::RegisterWithRegistrar(
    flutter::PluginRegistrarWindows* registrar) {
  auto plugin = std::make_unique<HotkeySystemPlugin>(
      registrar,
      std::make_unique<flutter::MethodChannel<flutter::EncodableValue>>(
          registrar->messenger(), "hotkey_system",
...
void HotkeySystemPlugin::Unregister(
    const flutter::MethodCall<flutter::EncodableValue>& method_call,
    std::unique_ptr<flutter::MethodResult<flutter::EncodableValue>> result) {
  const flutter::EncodableMap& args =
      std::get<flutter::EncodableMap>(*method_call.arguments());
...
void HotkeySystemPlugin::UnregisterAll(
    const flutter::MethodCall<flutter::EncodableValue>& method_call,
    std::unique_ptr<flutter::MethodResult<flutter::EncodableValue>> result) {
...
UINT HotkeySystemPlugin::GetVirtualKeyCodeFromString(
    const std::string key_code) {
  return kKnownVirtualKeyCodes.at(key_code);
}

UINT HotkeySystemPlugin::GetFsModifiersFromString(
...
void HotkeySystemPlugin::HandleMethodCall(
    const flutter::MethodCall<flutter::EncodableValue>& method_call,
    std::unique_ptr<flutter::MethodResult<flutter::EncodableValue>> result) {
...
void HotkeySystemPluginRegisterWithRegistrar(
    FlutterDesktopPluginRegistrarRef registrar) {
  HotkeySystemPlugin::RegisterWithRegistrar(
